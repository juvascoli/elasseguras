...
const [senha, setSenha] = useState('');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Preencha seus dados para realizar o cadastro.</Text>
      ...
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('contatoConfiavel')}>
